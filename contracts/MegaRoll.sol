...
// MegaRoll helps your migrate your existing Uniswap LP tokens to AllSwap LP ones
contract MegaRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'AllSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'MegaRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'MegaRoll: INSUFFICIENT_B_AMOUNT');
    }
